...
public class Program2 {
	...
	public static void main(String[] args) {
		...
		// vantagens: iniciar a instância com objetos preenchidos com os valores
		// digitados acima.
		Product product = new Product(name, price, quantity);

		// ******* Fim da Leitura dos dados ******

		// exibir utilizando toString (o java entende apenas o "product" -
		// implicitamente ele chama o 'toString'

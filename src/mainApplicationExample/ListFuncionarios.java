...
public class ListFuncionarios {
	// 1 - fazer um programa para ler um número inteiro N e depois os dados (id,
	// nome e salario) de N funcionários. Não deve haver repetição de id.
	// 2 - Efetuar o aumento de X por cento no salario de um determinado
	// funcionário. Para isso, o programa deve ler um id e o valor X. Se o id
	// informado não existir, mostrar uma mensagem e abortar a operação.
	// 3 - Mostrar a listagem atualizada dos funcionários, conforme exemplos.
	// 4 - * Aplicar tecnica de encapsulamento pois o salário só deverá ser mudado
	// por porcentagem.
	//
	// na pratica:
